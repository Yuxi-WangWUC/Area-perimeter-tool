...
def get_shape():
    ...
    # valid must re-initialised every time it is run in a loop
    ...
    # lists hold shape list for a single user
    shape_que = ""
    shape_list = []
    shape_err = "This is not a valid choice. Please try again"
    ...
    while expect_shape != "xxx" and MAX_QUE != num_shape:
        ...
        print()
        expect_shape = input("Choose a shape to calculate: ").lower().strip()
...
def triangle():
    ...
    if expect_shape == "triangle" or expect_shape == "tri":
...
def rectangle():
    ...
    if expect_shape == "rectangle" or expect_shape == "r":
...
def circle():
    # if circle is chosen
    if expect_shape == "circle" or expect_shape == "c":
...
def parallelogram():
    ...
    if expect_shape == "parallelogram" or expect_shape == "p":
...
def trapezium():
    ...
    if expect_shape == "trapezium" or expect_shape == "tra":
