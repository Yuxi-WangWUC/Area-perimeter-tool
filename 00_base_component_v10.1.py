...
if __name__ == "__main__":
    ...
    # each item in valid shape is a list with valid options (full name,
    ...
    while expect_shape != "xxx" or MAX_QUE != num_shape:
        ...
        # if triangle is chosen
            ...
            first_hypotenuse.append(hypotenuse_tri_1)
            second_hypotenuse.append(hypotenuse_tri_2)
            down_base.append(base_tri)
        ...
        # if rectangle is chosen
            ...
            # attend data to the lists
            upper_base.append(base_r)
            down_base.append(base_r)
        ...
        # if parallelogram is chosen
            ...
            if total_p_area != ans_p_area:
                ...
                print("This is the correct answer. Well done")
            # attend data to the lists
            first_hypotenuse.append(hypotenuse_p)
            second_hypotenuse.append(hypotenuse_p)
            upper_base.append(base_p)
            down_base.append(base_p)
        ...
        # if trapezium is chosen
            ...
            # attend data to the lists
            first_hypotenuse.append(hypotenuse_tra_1)
            second_hypotenuse.append(hypotenuse_tra_2)
            upper_base.append(hypotenuse_2)
            upper_base.append(base_tra_1)
            down_base.append(base_tra_2)
        ...
        if num_shape == MAX_QUE:
            ...
            print("You had asked one question. "
