    ...
    while expect_shape != "xxx" and MAX_QUE != num_shape:
        ...
        # if triangle is chosen
            ...
            if ans_tri_peri != total_tri_peri:
                print("Oops, this is incorrect. The real answer is {:.2f}. Try to get it next time!".format(total_tri_peri))
            else:
            ...
            if total_tri_area != ans_tri_area:
                print("Oops, this is incorrect. The real answer is {:.2f}. Try to get it next time!.".format(total_tri_area))
            else:
                print("Wow, this is the correct answer! Well done! You are getting there!")
